                ...
                <Dialog.Panel className="w-full max-w-md md:max-w-4xl mt-20 mb-10 transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  <div className="overflow-x-auto">
                    ...
                    <div className="mt-6 flex items-center justify-end gap-x-6">
                      <button
                        type="submit"
                        className="px-3 py-1 rounded-md sshadow-sm bg-gradient-to-r from-blue-600 via-blue-500 to-sky-400 text-white"
                      ...
                      <button
                        type="submit"
                        className="px-3 py-1 rounded-md sshadow-sm bg-gradient-to-r from-red-600 via-red-500 to-red-400 text-white"
