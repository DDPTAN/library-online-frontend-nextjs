        ...
        <div className="border-b border-gray-900/10 pb-8">
          <div className="mt-5 grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-6">
            ...
            <div className="col-span-full">
              ...
              {errors.isbn ? (
                <p className="mt-1 text-red-500 text-sm">{errors.isbn.message}</p>
              ) : (
                ""
              )}
            </div>
            ...
            <div className="col-span-full">
              ...
              {errors.pages ? (
                <p className="mt-1 text-red-500 text-sm">{errors.pages.message}</p>
              ) : (
                ""
              )}
            </div>
            ...
            <div className="col-span-full">
              ...
              {errors.author ? (
                <p className="mt-1 text-red-500 text-sm">{errors.author.message}</p>
              ) : (
                ""
              )}
            </div>
            ...
            <div className="col-span-full">
              <label htmlFor="description" className="text-bold text-gray-500">
                Description
              </label>
              <div className="relative mt-2 flex items-center">
                <textarea
            ...
            <div className="col-span-full">
              ...
              <div className="relative mt-2 items-center">
                ...
                />
                {errors.file ? (
                  <p className="mt-1 text-red-500 text-sm">{errors.file.message}</p>
                ) : (
                  ""
                )}
                <p
            ...
            <div className="col-span-full">
              ...
              {errors.qty ? (
                <p className="mt-1 text-red-500 text-sm">{errors.qty.message}</p>
              ) : (
                ""
              )}
            </div>
