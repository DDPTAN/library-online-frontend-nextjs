...
function ListBookReturned() {
  ...
  const filteredTransactions = transactions.filter((transaction: any) => {
    ...
    return (
      ...
      moment(transaction?.loanDate).format("DD MMMM YYYY").toLowerCase().includes(searchLower) ||
      moment(transaction?.returnDate).format("DD MMMM YYYY").toLowerCase().includes(searchLower) ||
      moment(transaction?.loanMaximum).format("DD MMMM YYYY").toLowerCase().includes(searchLower) ||
      (transaction?.isStatus ? "Borrowed" : "Returned").toLowerCase().includes(searchLower)
    );
  });
